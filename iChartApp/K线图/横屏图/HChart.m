    ...
    switch (sender.tag) {
        ...
        case 100:
        {
            ...
            if (seleted == 0) {
                ...
                yesBtn1.frame = CGRectMake(self.frame.size.width-110, 250, 30, 30);
                yesBtn1.tag = 1002;
                ...
                noBtn1.frame = CGRectMake(self.frame.size.width-50, 250, 30, 30);
                noBtn1.tag = 1003;
                ...
                pick.frame    = CGRectMake(0, 250, self.frame.size.width, 160);
                yesBtn.frame  = CGRectMake(self.frame.size.width-110, 250, 30, 30);
                noBtn.frame   = CGRectMake(self.frame.size.width-50, 250, 30, 30);
        ...
        case 101:
        {
            ...
            if (seleted1 == 0) {
                ...
                pick = [[UIPickerView alloc] initWithFrame:CGRectMake(0, 250,self.frame.size.width,150)];
                ...
                yesBtn1.frame = CGRectMake(self.frame.size.width-110, 250, 30, 30);
                noBtn1.frame  = CGRectMake(self.frame.size.width-50 , 250, 30, 30);
                pick1.frame   = CGRectMake(0, 250, self.frame.size.width, 160);
                [UIView commitAnimations];
...
- (void)reBtn:(UIButton *)sender
{
    [UIView beginAnimations:nil context:nil];
    [UIView setAnimationDuration:.2f];
    yesBtn.frame  = CGRectMake(self.frame.size.width-90, 250, 30, 30);
    noBtn.frame   = CGRectMake(self.frame.size.width-50, 250, 30, 30);
    
    yesBtn1.frame = CGRectMake(self.frame.size.width-90, 250, 30, 30);
    noBtn1.frame  = CGRectMake(self.frame.size.width-50, 250, 30, 30);
    pick.frame    = CGRectMake(0, 250, self.frame.size.width, 162);
    pick1.frame   = CGRectMake(0, 250, self.frame.size.width, 162);
    seleted              = 0;
    seleted1             = 0;
