...
@interface CandleViewController : UIViewController<OptionViewControllerDelegate,UISearchBarDelegate,UIAlertViewDelegate,ChartDelegate,HChartDelegate,MBProgressHUDDelegate> {
    UILabel * label;
    UILabel * label1;
    UILabel * label2;
    UILabel * label3;
...
@property(nonatomic,assign) int LongperiodEma;
@property(nonatomic,assign) int ShortperiodEma;
@property(nonatomic,assign) int SignaperiodEma;
...
@property(nonatomic,strong) NSMutableArray * allProiod;
